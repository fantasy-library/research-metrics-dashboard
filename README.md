...
- Optional institutional token: `ELSEVIER_INSTTOKEN` or `VITE_ELSEVIER_INSTTOKEN` (if your subscription requires `insttoken` on SciVal calls). Railway: set `ELSEVIER_INSTTOKEN` alongside `SCIVAL_API_KEY` when needed.
