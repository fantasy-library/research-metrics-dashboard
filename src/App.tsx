...
function App() {
  ...
  const [availableMetrics, setAvailableMetrics] = useState<MetricOption[]>([
    ...
    },
    {
      ...
      description: 'Citation count excluding self-citations',
      enabled: true
    },
    {
      id: 'citationsIncl',
      label: 'Citations (Incl. Self-citation)',
      description: 'Citation count including self-citations',
      enabled: false
    },
    {
      id: 'hIndex',
  ...
  const handleSingleAuthor = async (authorId: string) => {
    try {
      const data = await apiService.getAuthorMetrics(authorId, apiKey, selectedYearRange, availableMetrics, selectedIncludedDocs);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (ids.length === 1) {
        ...
        try {
          const data = await apiService.processMultipleAuthors(ids, apiKey, selectedYearRange, availableMetrics, selectedIncludedDocs);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex flex-col">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-slate-200/60 sticky top-0 z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3">
                ...
                />
                <div className="text-slate-400 text-xl sm:text-2xl font-light">|</div>
                <img 
        ...
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-t border-amber-200/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-center space-y-3 sm:space-y-0 sm:space-x-4">
              <Info className="h-4 w-4 text-amber-600 flex-shrink-0 mx-auto sm:mx-0 mt-1" />
              <div className="flex-1">
                <p className="text-sm text-amber-800 text-justify leading-relaxed">
                  <span className="font-semibold">Disclaimer:</span> This research metrics dashboard has been generated using data provided by Elsevier's SciVal APIs. Please be aware that metrics presented in this dashboard are subject to change over time as the underlying data is updated and refined. Contact us if you need a more comprehensive report, see this sample report as reference.
                </p>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-3 space-y-2 sm:space-y-0">
                  <div className="flex items-center space-x-2">
                    ...
                    <a 
                      ...
                      className="text-xs text-amber-700 font-medium underline hover:text-amber-900 transition-colors duration-200"
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs text-amber-700 font-medium underline hover:text-amber-900 transition-colors duration-200 whitespace-nowrap"
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 sm:p-8 mb-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Year Range and Document Types Selection - Same Line */}
            ...
            <div className="max-w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter Scopus Author ID(s) - separate multiple IDs with commas"
                  className="w-full pl-12 pr-4 py-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/80 backdrop-blur-sm text-slate-900 placeholder-slate-500"
                  disabled={loading}
                  required
                />
              </div>
              <p className="mt-2 text-xs text-slate-500">
                Example: 7003551184 or 7003551184,7005123456 for multiple authors
              </p>
            </div>
